...
const Hero = () => {
  ...
  const whileInViewInittial = isMobile ? -100 : -600;
  const whileInViewwhileInView = isMobile ? 0 : 0;
  return (
    <motion.div id="home" className="md:my-14 md:mb-44 flex flex-col md:flex-row w-full">
      <div className="flex md:w-1/2 w-full flex-col mt-10  md:mt-20 md:ml-32 ml-2">
        <motion.h1
          initial={{ x: whileInViewInittial }}
          whileInView={{ x: whileInViewwhileInView }}
